  ...
  return (
    <>
      <Group justify="space-between" mb="lg">
        <div>
          <Title order={2}>Home Sections</Title>
          <Text size="sm" c="dimmed">Manage homepage content sections</Text>
        </div>
        <Button component={Link} href="/admin/home/new">New Section</Button>
      </Group>
      ...
      {sections && sections.length === 0 && !search && (
        <Center py="xl">
          <Stack align="center" gap="xs">
            ...
            <Button component={Link} href="/admin/home/new" variant="light" size="compact-sm">Create first section</Button>
          </Stack>
        </Center>
      )}
            ...
            {filtered.map((s, i) => (
              <Table.Tr key={s.id}>
                ...
                <Table.Td>
                  <Group gap="xs">
                    <Tooltip label="Edit">
                      <ActionIcon component={Link} href={`/admin/home/${s.id}`} variant="light" color="blue" size="sm">
      ...
      <Modal opened={!!deleteId} onClose={() => setDeleteId(null)} title="Delete Section" centered>
        <Text size="sm" mb="md">Are you sure you want to delete this home section?</Text>
